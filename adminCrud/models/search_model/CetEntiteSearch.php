...
use app\models\cetcal_model\CetEntite;

/**
 * CetEntiteSearch represents the model behind the search form of `app\models\cetcal_model\CetEntite`.
 */
class CetEntiteSearch extends CetEntite
{
    /**
     * {@inheritdoc}
     */
