 ...
 * @property Produit $fkProduit
 */
class Joinproduit extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['Fk_produit'], 'exist', 'skipOnError' => true, 'targetClass' => Produit::className(), 'targetAttribute' => ['Fk_produit' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Produit::className(), ['id' => 'Fk_produit']);
    }
}
