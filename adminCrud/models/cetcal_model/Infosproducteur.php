 ...
 */
class Infosproducteur extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Entite::className(), ['pk' => 'id']);
    }
    ...
    {
        return $this->hasMany(Producteurlieu::className(), ['Fk_producteur' => 'id']);
    }
}
