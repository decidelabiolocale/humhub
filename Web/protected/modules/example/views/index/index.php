...
\humhub\modules\example\assets\Assets::register($this);
...
<div class="panel-heading"><strong>Run Cron</strong> <?= Yii::t('ExampleModule.base', 'overview') ?></div>

<div class="panel-body">
    <p><?= Yii::t('ExampleModule.base', 'Hello World!') ?></p>

    <?=  Button::primary(Yii::t('ExampleModule.base', 'Say Hello!'))->action("example.hello")->loader(false); ?></div>
